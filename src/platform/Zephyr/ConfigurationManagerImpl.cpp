...
void ConfigurationManagerImpl::InitiateFactoryResetWithoutReboot()
{
    PlatformMgr().ScheduleWork(DoFactoryResetWithoutReboot);
}
...
void ConfigurationManagerImpl::DoFactoryResetWithoutReboot(intptr_t arg)
{
    ChipLogProgress(DeviceLayer, "Performing factory reset without reboot");
