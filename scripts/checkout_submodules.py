...
def update_gitmodules_with_token(token: str) -> str:
    """
    Update the .gitmodules file to include the PAT in the telink_matter_lighting_cbb submodule URL.
    ...
    for section in config.sections():
        if 'lighting_cbb' in section:
            ...
            if token and 'https://' in original_url:
                ...
                logging.info(f'Updated URL for telink_matter_lighting_cbb to include PAT')
